...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '浮迷', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '健康努力生活捏', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hlblog.one/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '打工人, 鼠鼠', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'mail@xxxx.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  WIDGET_PET_LINK: 'https://fastly.jsdelivr.net/gh/stevenjoezhang/live2d-widget@latest/waifu-tips.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
